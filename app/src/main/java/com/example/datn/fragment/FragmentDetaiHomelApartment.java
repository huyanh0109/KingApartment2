...
public class FragmentDetaiHomelApartment extends Fragment implements OnMapReadyCallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                NavHostFragment.findNavController(FragmentDetaiHomelApartment.this).navigate(R.id.action_fragmentDetaiHomelApartment_to_fragmentDaddy, bundle);
            }
        };
